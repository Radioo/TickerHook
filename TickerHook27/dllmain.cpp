...
// Hooked functions
void(__fastcall* TickerFunc1)(__int64 a1, int emptyFlag, unsigned __int8 a3) = nullptr;
void __fastcall TickerFunc1_rep(__int64 a1, int emptyFlag, unsigned __int8 a3)
{
    if (!emptyFlag)
    {
    ...
    TickerFunc1(a1, emptyFlag, a3);
}

__int64(__fastcall* TickerFunc2)(char* a1, int a2) = nullptr;
__int64 __fastcall TickerFunc2_rep(char* a1, int a2)
{
...
__int64(__fastcall* TickerFunc3)(char* a1, int a2) = nullptr;
__int64 __fastcall TickerFunc3_rep(char* a1, int a2)
{
...
BOOL APIENTRY DllMain(HMODULE dll_instance, DWORD reason, LPVOID) {
    if (reason == DLL_PROCESS_ATTACH)
    {
        ...
        uintptr_t TickerFunc1Addr = 0x5C73B0;
        uintptr_t TickerFunc2Addr = 0x5C6F90;
        uintptr_t TickerFunc3Addr = 0x5C7020;
        ...
        std::cout << "TickerHook for IIDX27 (2020092900)" << std::endl;
