...
{
    //std::cout << "Fired1: " << a1 << a2 << std::endl;
    TickerOut(a1);
...
BOOL APIENTRY DllMain(HMODULE dll_instance, DWORD reason, LPVOID) {
    if (reason == DLL_PROCESS_ATTACH)
    {
        ...
        uintptr_t TickerFunc1Addr = 0x1E9D0;
        uintptr_t TickerFunc2Addr = 0x1EB10;
        uintptr_t TickerFunc3Addr = 0x1ECA0;
        ...
        std::cout << "TickerHook for IIDX10 (JAE)" << std::endl;
