...
int(__cdecl* TickerFunc3)(char* a1, int a2) = nullptr;
int __cdecl TickerFunc3_rep(char* a1, int a2)
{
...
BOOL APIENTRY DllMain(HMODULE dll_instance, DWORD reason, LPVOID) {
    if (reason == DLL_PROCESS_ATTACH)
    {
        ...
        uintptr_t TickerFunc1Addr = 0x7F2F0;
        uintptr_t TickerFunc2Addr = 0x7F390;
        uintptr_t TickerFunc3Addr = 0x7F760;
        ...
        std::cout << "TickerHook for IIDX15 (2008031100)" << std::endl;
