...
BOOL APIENTRY DllMain(HMODULE dll_instance, DWORD reason, LPVOID) {
    if (reason == DLL_PROCESS_ATTACH)
    {
        ...
        uintptr_t TickerMusicSelectAddr1 = 0x57DE50;
        uintptr_t TickerMusicSelectAddr2 = 0x57DEE0;
        uintptr_t TickerMusicSelectAddr3 = 0x57E270;
        ...
        std::cout << "TickerHook for IIDX29 (2021101301)" << std::endl;
