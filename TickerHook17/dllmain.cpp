...
// Hooked functions
int(__cdecl* TickerFunc1)(int a1, int a2) = nullptr;
int __cdecl TickerFunc1_rep(int a1, int a2)
{
...
int(__cdecl* TickerFunc2)(int a1, int a2) = nullptr;
int __cdecl TickerFunc2_rep(int a1, int a2)
{
...
BOOL APIENTRY DllMain(HMODULE dll_instance, DWORD reason, LPVOID) {
    if (reason == DLL_PROCESS_ATTACH)
    {
        ...
        uintptr_t TickerFunc1Addr = 0x2DD50;
        uintptr_t TickerFunc2Addr = 0x2DDC0;
        uintptr_t TickerFunc3Addr = 0x2DF60;
        ...
        std::cout << "TickerHook for IIDX17 (2010071200)" << std::endl;
