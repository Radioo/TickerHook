...
BOOL APIENTRY DllMain(HMODULE dll_instance, DWORD reason, LPVOID) {
    if (reason == DLL_PROCESS_ATTACH)
    {
        ...
        emptyTextPath = bm2dx_addr + 0x14FB60;
        ...
        uintptr_t TickerFunc1Addr = 0x905D0;
        uintptr_t TickerFunc2Addr = 0x90560;
        uintptr_t TickerFunc3Addr = 0x90770;
        ...
        std::cout << "TickerHook for IIDX21 (2014071600)" << std::endl;
